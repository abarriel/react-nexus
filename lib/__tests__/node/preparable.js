...
describe('preparable', () => {
  ...
  it('static method settles correctly', async () => {
    const delay = 100;
    const spy = sinon.spy();
    class Test extends React.Component {}
    const PreparableTest = preparable(async () => {
  ...
  it('preparable decorator static method settles correctly', async () => {
    const delay = 100;
    const spy = sinon.spy();
    @preparable(async () => {
      await Promise.resolve(spy()).delay(delay);
  ...
  it('correctly chains preparations', async () => {
