...
describe('HTTP.Store', () => {
  describe('#options', () => {
    describe('rewritePath', () => {
      ...
      it('should correctly access the server with the rewritten path for any path of the store', async () => {
      ...
      it('should correctly access the server with the rewritten path with a query', async () => {
        const store = HTTPStore.create(
          '/foo/:foo/bar/:bar',
          { protocol: 'http', hostname: 'localhost', port: API_PORT },
          {
